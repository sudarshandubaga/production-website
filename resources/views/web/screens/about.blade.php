        ...
        <div class="container">
            ...
            <div>
                @foreach ($members as $member)
                    <div class="lg:grid lg:grid-cols-3 flex flex-col gap-10 mb-10">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="py-2">
                                <strong class="text-orange-500">IMDB:</strong>
                                <a href="{{ $member->imdb_link }}" target="_blank"
                                    class="hover:text-orange-500">{{ $member->imdb_link }}</a>
                            </div>
